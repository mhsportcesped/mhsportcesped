...
export const products: Product[] = [
  ...
  // CÉSPED ARTIFICIAL EN ROLLO
  {
    ...
    category: "en-rollo",
    image: ankaraMain,
    images: [ankaraMain, prodAnkaraRollo, ankara1, ankara2, ankara3, ankara4, ankara5, ankaraTech],
    height: 45,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: pragaMain,
    images: [pragaMain, prodPragaRollo, praga1, praga2, praga3, pragaTech],
    height: 40,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: kievMain,
    images: [kievMain, prodKievRollo, kiev1, kiev2, kiev3, kiev4, kievTech],
    height: 20,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: oportoMain,
    images: [oportoMain, prodOportoRollo, oporto1, oporto2, oporto3, oportoTech],
    height: 33,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: berlinMain,
    images: [berlinMain, prodBerlinRollo, berlin1, berlin2, berlin3, berlinTech],
    height: 24,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: budapestMain,
    images: [budapestMain, prodBudapestRollo, budapest1, budapest2, budapest3, budapestTech],
    height: 18,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: danubioMain,
    images: [danubioMain, prodDanubioRollo, danubio1, danubio2, danubio3],
    height: 15,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: vienaMain,
    images: [vienaMain, prodVienaRollo, viena1, viena2, vienaTech],
    height: 8,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: prodSueciaCorte,
    images: [prodSueciaCorte, prodSueciaRollo],
    height: 7,
  ...
  },
  {
    ...
    category: "en-rollo",
    image: osloMain,
    images: [osloMain, prodOsloRollo, osloTech],
    height: 7,
