  ...
  <main className="py-20 animate-in fade-in duration-700">
    <div className="container max-w-4xl">
      <div className="flex items-center gap-4 mb-10">
        ...
        <h1 className="text-4xl font-black italic uppercase tracking-tight">Política de Privacidad</h1>
      </div>
      <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
        <p>
          En cumplimiento con el RGPD, MH Sport informa a los usuarios sobre el tratamiento de sus datos personales.
        </p>
        <h2 className="text-2xl font-black italic text-foreground uppercase pt-4">Responsable del Tratamiento</h2>
        <p>
          MH SPORT CÉSPED ARTIFICIAL Y JARDINES S.L., con domicilio en Hellín, Albacete, España.
        </p>
        <h2 className="text-2xl font-black italic text-foreground uppercase pt-4">Finalidad de los Datos</h2>
        <p>
        ...
        <h2 className="text-2xl font-black italic text-foreground uppercase pt-4">Sus Derechos</h2>
        <p>
