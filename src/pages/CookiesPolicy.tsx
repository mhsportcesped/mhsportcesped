  ...
  <main className="py-20 animate-in fade-in duration-700">
    <div className="container max-w-4xl">
      <div className="flex items-center gap-4 mb-10">
        ...
        <h1 className="text-4xl font-black italic tracking-tight">Política de Cookies</h1>
      </div>
      <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
        ...
        <h2 className="text-2xl font-black italic text-foreground pt-4">¿Qué son las cookies?</h2>
        <p>
        ...
        <h2 className="text-2xl font-black italic text-foreground pt-4">Tipos de cookies que utilizamos</h2>
