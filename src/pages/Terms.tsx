  ...
  <main className="py-20 animate-in fade-in duration-700">
    <div className="container max-w-4xl">
      <div className="flex items-center gap-4 mb-10">
        ...
        <h1 className="text-4xl font-black italic tracking-tight">Términos y Condiciones</h1>
      </div>
      <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
        <p>
          Al acceder a este sitio web, usted acepta los siguientes términos y condiciones de uso.
        </p>
        <h2 className="text-2xl font-black italic text-foreground pt-4">Condiciones de Venta</h2>
        <p>
        ...
        <h2 className="text-2xl font-black italic text-foreground pt-4">Envíos y Devoluciones</h2>
        <p>
        ...
        <h2 className="text-2xl font-black italic text-foreground pt-4">Propiedad Intelectual</h2>
        <p>
